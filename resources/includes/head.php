...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="./resources/images/logo_128.png"/>
        ...
        <meta name="keywords" content="parth shah, web applications, link shortener, track link, shorten url" />
    ...
    <body>
        <nav class="header">
            <div class="nav-wrapper blue-grey darken-3">
                <a href="index.php" class="brand-logo logo-font">URL Shortener</a>
                <ul id="nav-mobile" class="right hide-on-med-and-down">
                    <li class="<?php echo $home ?>"><a href="index.php"><i class="material-icons left">home</i>Home</a></li>
        ...
        <ul id="slide-out" class="side-nav fixed">
            <li><img src="./resources/images/logo_128.png" class="logo-img"></li>
            <li><div class="divider"></div></li>
            <li class="center-align"><h6>Current Active Links : <b><?php echo $dir_count; ?></b></h6></li>
            <li><div class="divider"></div></li>
            <li class="<?php echo $home ?>"><a href="index.php"><i class="material-icons">home</i>Home</a></li>
